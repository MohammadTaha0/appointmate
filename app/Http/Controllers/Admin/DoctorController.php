...
class DoctorController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $records = User::whereRole('DO')->when(!$this->role, function ($q) {
        ...
        return view('admin.doctor.index', compact('records', 'key', 'value', 'orderBy', 'orderType'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.doctor.create', compact('companies', 'company'));
    }
    public function edit(Request $request, $company_slug, $id)
    {
        ...
        $data = User::whereRole('DO')->when(!$this->role, function ($q) {
            return $q->whereCompany($this->company);
        })->findOrFail($id);
        return view('admin.doctor.create', compact('data', 'companies', 'company'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $old = null;
        if ($request->id) {
            $old = User::whereRole('DO')->findOrFail($request->id);
        }
