...
@push('main_bread_url', route('admin.doctor.index', ['company_slug' => Str::slug(auth()->user()->getCompany->name ?? 'SA')]))
@push('second_bread', (isset($data) ? 'Edit' : 'Create') . ' Doctor')
@section('main')
    <div class="row">
        <div class="col-12">
            <div class="card">
...
@push('scripts')
    <script>
        ...
        }, "{{ route('admin.doctor.store', ['company_slug' => Str::slug(auth()->user()->getCompany->name ?? 'SA')]) }}", "{{ route('admin.doctor.index', ['company_slug' => Str::slug(auth()->user()->getCompany->name ?? 'SA')]) }}")
    </script>
@endpush
